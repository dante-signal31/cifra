...
from cifra.attack.simple_attacks import _assess_key, _assess_key_in_memory, \
    _assess_key_in_pool, _assess_key_in_pool_in_memory
...
def _analize_text(nargs):
    ...
    return _assess_caesar_key(ciphered_text, key, charset, in_memory, in_pool, _database_path)
